...
if (isset($_GET['draw'])) {
    ...
    $where = "WHERE (trn_orders.done_date >= NOW() OR coalesce(trn_orders.total_value, 0) <> coalesce(trn_orders.total_payment, 0)) AND (trn_orders.date BETWEEN '$filterByDate[start_date]' AND '$filterByDate[end_date]')";
