...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-3">
                <label>Periode Tgl. Pengeluaran</label>
                <?= \Core\Form::input('month', 'month', ['class' => 'form-control filters', 'placeholder' => 'Periode Tgl. Pengeluaran', 'value' => date("Y-m")]) ?>
            </div>
            <div class="col-3">
                <label>Status</label>
